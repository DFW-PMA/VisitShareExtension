...
final class AppGlobalInfoConfig:NSObject
{
    ...
    static let sGlobalInfoAppVers:String                                 = "v1.5703"
    ...
    static let sGlobalInfoAppLogFilespec:String                          = "VisitShareExtensionAppEx.log"
    static let sGlobalInfoAppLastGoodLogFilespec:String                  = "VisitShareExtensionAppEx.last_good.log"
    static let sGlobalInfoAppLastCrashLogFilespec:String                 = "VisitShareExtensionAppEx.crashed_last.log"
    static let sGlobalInfoAppCrashMarkerFilespec:String                  = "VisitShareExtensionAppEx.crash_marker.txt"
